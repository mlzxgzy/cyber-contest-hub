    ...
    <el-table v-loading="loading" :data="questionList" @selection-change="handleSelectionChange"
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Discount" @click="handleAddTag(scope.row)"
                     v-hasPermi="['exam:question:edit', 'exam:questionTag:add']">添加Tag
          </el-button>
...
import {listQuestion, delQuestion} from "@/api/exam/question";
...
function handleUpdate(row) {
  ...
  router.push({path: '/question/edit', query: {id: _id}});
}
